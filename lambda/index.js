...
// const apiKey = "868afe26aed87b569635801db9004f4a"
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        ...
        `<speak> 
            <voice name="Matthew">
                Hello! <break strength="weak"/> this is SK Weather assistant.
...
const WeatherIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        return await axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=868afe26aed87b569635801db9004f4a`)
            .then((response)=>{
